...
```{r}
#st_write(specific_ecoregion, "C:/Users/shamekj/Desktop/R Docs/CCVI/Ecoregion Shapefile/WV.shp")
```
...
```{r}
st_write(clipped_species_range, "Tsuga_distribution.shp", append=FALSE)
```
